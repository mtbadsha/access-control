        ...
        <div class="col-md-10 col-md-offset-1">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <form class="form-horizontal" role="form" method="POST" action="{{URL::to('/post_search_section')}}">
                        ...
                        <div class="form-group">
                            <label class="col-md-4 control-label">Section Name</label>
                            <div class="col-md-6">
    ...
    <script>
        ...
        $("#division").on('change',function (e) {
            ...
            $.get('/ajaxdivision?division=' +division,function(data)
            {
                ...
                {
                    $('#department').append('<option value="'+subcatObj.organization_name+'">'+subcatObj.organization_name+'</option>');
                })
        ...
        $("#department").on('change',function (e) {
           ...
           // document.write(department);
            $.get('/ajaxdepartment?department=' +department,function(data)
            {
                $('#section').empty();
                $.each(data,function(index,subcatObj)
                {
                    $('#section').append('<option value="'+subcatObj.id+'">'+subcatObj.organization_name+'</option>');
                })
