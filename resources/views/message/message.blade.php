        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <div class="panel-heading acl_heading_left">All Messages</div>
                    <br/>
                  </div>
                ...
                <div class="panel-body">
                    <div class="dataTable_wrapper">
                        <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                            <thead>
                            <tr>
                                <th class="resource-name" style="width: 20%">Title</th>
                                <th class="resource-name" style="width: 60%">Description</th>
                            ...
                            @foreach($messages as $message)
                                <tr>
                                    <td>{{$message->title}}</td>
                                    <td>{{substr($message->description,0,60)}}..</td>
                                    <td><a href="{{URL::to('message/'.$message->id)}}">Details</a></td>
                                </tr>
                            @endforeach
                            </tbody>
                        </table>
